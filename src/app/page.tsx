...
function ProductShowcase() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
      <div className="relative aspect-4/3 w-full rounded-6xl overflow-hidden bg-[#fefef4] rounded-2xl shadow-2xl flex items-center justify-center">
        <Image
  ...
  return (
    <main className="min-h-screen bg-[#F5F5F7] text-[#1d1d1f] selection:bg-black selection:text-white">
      ...
      <div className="max-w-3xl mx-auto py-20 sm:py-32 px-8 text-center">
        <p className="text-xl sm:text-2xl md:text-3xl font-light leading-relaxed mb-8">
